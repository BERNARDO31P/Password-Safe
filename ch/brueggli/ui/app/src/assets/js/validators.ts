...
export class CustomValidators {
  public static patternGenerate = `^((?=.*[A-Z])(?=.*[a-z])(?=.*[\\d])|(?=.*[a-z])(?=.*[A-Z])(?=.*[!-\\/:-@[-\`{-~])|(?=.*[A-Z])(?=.*[\\d])(?=.*[!-\\/:-@[-\`{-~])|(?=.*[a-z])(?=.*[\\d])(?=.*[!-\\/:-@[-\`{-~])|(?=.*[A-Z])(?=.*[a-z])(?=.*[\\d])(?=.*[!-\\/:-@[-\`{-~])).[A-Za-z\\d!-\\/:-@[-\`{-~]{14,14}$`;
  public static patternCheck = `^((?=.*[A-Z])(?=.*[a-z])(?=.*[\\d])|(?=.*[a-z])(?=.*[A-Z])(?=.*[!-\\/:-@[-\`{-~])|(?=.*[A-Z])(?=.*[\\d])(?=.*[!-\\/:-@[-\`{-~])|(?=.*[a-z])(?=.*[\\d])(?=.*[!-\\/:-@[-\`{-~])|(?=.*[A-Z])(?=.*[a-z])(?=.*[\\d])(?=.*[!-\\/:-@[-\`{-~])).[A-Za-z\\d!-\\/:-@[-\`{-~]{1,}$`;
