CREATE DATABASE IF NOT EXISTS ${MYSQL_DB} DEFAULT CHARACTER SET UTF8 DEFAULT COLLATE utf8_bin;
USE ${MYSQL_DB};
...
RENAME USER admin@'%' TO admin@'10.0.2.3';
REVOKE ALL PRIVILEGES ON *.* FROM admin@'10.0.2.3';
GRANT ALL PRIVILEGES ON ${MYSQL_DB}.* TO admin@'10.0.2.3';
